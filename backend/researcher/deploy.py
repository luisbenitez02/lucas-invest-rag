...
def main():
    print("Lucas Researcher Service - Docker Deployment")
    print("===========================================")
    ...
    ecr_repository = "lucas-researcher"
    ...
    try:
        services = run_command(
            [
                ...
                region,
                "--query",
                "ServiceSummaryList[?ServiceName=='lucas-researcher'].ServiceArn",
                "--output",
                "json",
            ],
            capture_output=True,
        ...
        if services:
            ...
            if service_arns:
                                ...
                                "ImageRepository": {
                                    ...
                                    "ImageConfiguration": {
                                        ...
                                        "RuntimeEnvironmentVariables": {
                                            ...
                                            "LUCAS_API_KEY": os.environ.get("LUCAS_API_KEY", ""),
                                            "LUCAS_API_ENDPOINT": os.environ.get(
                                                "LUCAS_API_ENDPOINT", ""
                                            ),
                                        },
                                    },
                ...
                print("  2. Select 'lucas-researcher' service")
